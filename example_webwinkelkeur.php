<?php include_once 'kiyoh.php'; $ScoreAndReviews = get_kiyoh_score_and_reviews('[HASH]', 2); ?><!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>Webwinkel Keur</title>
		<style type="text/css">
			body {
				margin: 0;
	...
	<body>
		<a href="https://www.webwinkelkeur.nl/">
			<img src="https://www.webwinkelkeur.nl/images/logo1.png" alt="Webwinkel Keur" />
